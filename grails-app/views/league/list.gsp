			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="closed" title="${message(code: 'league.closed.label', default: 'Closed')}" />
				...
				<g:each in="${leagueInstanceList}" status="i" var="leagueInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${leagueInstance.id}">${fieldValue(bean: leagueInstance, field: "closed")}</g:link></td>
