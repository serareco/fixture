			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="team.leagues.label" default="Leagues" /></th>
					
						<g:sortableColumn property="nameFootballTeam" title="${message(code: 'team.nameFootballTeam.label', default: 'Name Football Team')}" />
				...
				<g:each in="${teamInstanceList}" status="i" var="teamInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: teamInstance, field: "leagues")}</td>
					
						<td>${fieldValue(bean: teamInstance, field: "nameFootballTeam")}</td>
