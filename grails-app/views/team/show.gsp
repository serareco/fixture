	...
	<body>
		...
		<div id="show-team" class="content scaffold-show" role="main">
			...
			<ol class="property-list team">
				...
				<g:if test="${teamInstance?.leagues}">
				<li class="fieldcontain">
					<span id="leagues-label" class="property-label"><g:message code="team.leagues.label" default="Leagues" /></span>
					
						<span class="property-value" aria-labelledby="leagues-label"><g:link controller="league" action="show" id="${teamInstance?.leagues?.id}">${teamInstance?.leagues?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${teamInstance?.nameFootballTeam}">
				<li class="fieldcontain">
					<span id="nameFootballTeam-label" class="property-label"><g:message code="team.nameFootballTeam.label" default="Name Football Team" /></span>
					
						<span class="property-value" aria-labelledby="nameFootballTeam-label"><g:fieldValue bean="${teamInstance}" field="nameFootballTeam"/></span>
